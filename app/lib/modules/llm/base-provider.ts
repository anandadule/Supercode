...
/** How long to cache dynamic model lists before re-fetching. 10 minutes. */
...
export abstract class BaseProvider implements ProviderInfo {
  ...
  getModelsFromCache(options: {
    ...
    // Invalidate stale caches so newly-released models become visible without a hard refresh.
