  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-bolt-elements-background-depth-2 p-2 flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 preview-toolbar-icons">
          <IconButton
            icon="i-ph:devices"
            onClick={toggleDeviceMode}
            title={isDeviceModeOn ? 'Switch to Responsive Mode' : 'Switch to Device Mode'}
            size="xxl"
            iconClassName="text-bolt-elements-textSecondary"
          />
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-bolt-elements-background-depth-1 rounded-xl shadow-2xl border border-bolt-elements-borderColor overflow-hidden">
                  <div className="p-3 border-b border-bolt-elements-borderColor">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            showDeviceFrame ? 'bg-accent-500' : 'bg-bolt-elements-background-depth-3'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            isLandscape ? 'bg-accent-500' : 'bg-bolt-elements-background-depth-3'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-bolt-elements-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-bolt-elements-item-backgroundActive bg-bolt-elements-background-depth-1"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-bolt-elements-textTertiary group-hover:text-accent-500 transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        <span className="font-medium group-hover:text-accent-500 transition-colors duration-200">
                          {size.name}
                        </span>
                        <span className="text-xs text-bolt-elements-textTertiary group-hover:text-accent-500 transition-colors duration-200">
