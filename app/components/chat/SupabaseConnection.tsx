...
export function SupabaseConnection() {
  ...
  return (
    <div className="relative">
      <div className="flex border border-[#3ECF8E]/30 rounded-md text-sm bg-[#3ECF8E]/10">
        <Button
          active
          disabled={connecting}
          onClick={() => setIsDialogOpen(!isDialogOpen)}
          className="!bg-transparent hover:!bg-[#3ECF8E]/20 !text-[#3ECF8E] flex items-center gap-2"
        >
          <img
            className="w-4 h-4"
            height="20"
