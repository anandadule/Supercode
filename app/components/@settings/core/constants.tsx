...
const FigmaIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path d="M12 2H8a4 4 0 0 0 0 8h4V2Z" fill="#1ABCFE" />
    <path d="M12 10H8a4 4 0 0 0 0 8h4v-8Z" fill="#0ACF83" />
    <path d="M12 10h4a4 4 0 0 1 0 8h-4v-8Z" fill="#FF7262" />
    <path d="M12 2h4a4 4 0 0 1 0 8h-4V2Z" fill="#F24E1E" />
    <path d="M8 18a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" fill="#A259FF" />
  </svg>
);
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  figma: 'Import design frames from Figma',
};
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'figma', visible: true, window: 'user' as const, order: 12 },
