...
import FigmaTab from '~/components/@settings/tabs/figma/FigmaTab';
...
const BetaLabel = () => (
  <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-full bg-purple-500/10">
    <span className="text-[10px] font-medium text-purple-500">BETA</span>
  </div>
);
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-bolt-elements-borderColor">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      <button
                        onClick={handleBack}
                        className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-purple-500/10 group transition-colors duration-150"
                      >
